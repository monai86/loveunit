      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-6 border-b border-[var(--line)]">
        <div className="space-y-1">
          <div className="flex flex-wrap items-center gap-2">
            <span className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 text-[11px] font-bold">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 shrink-0 w-full sm:w-auto">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-white border border-[var(--line)] hover:bg-gray-50 text-xs font-bold text-[var(--ink)] shadow-2xs transition-all cursor-pointer"
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5">
          {kpiBlocks.map((block) => {
            ...
            return (
              <div key={block.title} className={`p-3.5 sm:p-5 rounded-2xl border ${block.color} shadow-2xs space-y-2 flex flex-col justify-between transition-all`}>
                  ...
                  {recentRegistrations.map((reg) => {
                    ...
                    return (
                      <tr key={regObj.id} className="hover:bg-gray-50/80 transition-colors">
                        ...
                        <td className="p-3 font-mono text-gray-600 whitespace-nowrap">{regObj.phone}</td>
