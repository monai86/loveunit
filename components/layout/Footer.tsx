            ...
            <div className="space-y-3 text-sm text-[var(--ink)] font-medium">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="space-y-1 font-bold">
                  <p>คุณเปา: <a href="tel:0969866245" className="hover:underline text-[var(--burgundy-600)] inline-block py-0.5">09-6986-6245</a></p>
                  <p>คุณแตงโม: <a href="tel:0656274319" className="hover:underline text-[var(--burgundy-600)] inline-block py-0.5">06-5627-4319</a></p>
                </div>
              </div>
