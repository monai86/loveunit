...
export function MobileBottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 p-2 lg:hidden pointer-events-none select-none">
      <div className="mx-auto max-w-md bg-[#7A1020] text-white rounded-2xl p-1.5 shadow-2xl border border-white/20 flex items-center justify-around pointer-events-auto backdrop-blur-lg">
        {navItems.map((item) => {
        ...
        <Link
          href="/register"
          className="flex items-center gap-1.5 bg-[#C13A2B] hover:bg-[#D94534] text-white font-extrabold px-4 py-2 rounded-xl text-xs shadow-md transition-all active:scale-95"
        >
