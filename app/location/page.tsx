...
export const metadata: Metadata = {
  ...
  description: 'แผนที่และข้อมูลการเดินทางสู่ห้องประชุม 217 อาคารสิริวิทยา คณะศิลปศาสตร์ มหาวิทยาลัยมหิดล ศาลายา กิจกรรม MUMT Blood Donation 2026 โดยคณะเทคนิคการแพทย์ ม.มหิดล',
  alternates: {
    canonical: '/location',
  },
  openGraph: {
    title: 'สถานที่จัดงาน & แผนที่การเดินทาง | MUMT Blood Donation 2026',
    description: 'ห้องประชุม 217 อาคารสิริวิทยา คณะศิลปศาสตร์ ม.มหิดล ศาลายา พร้อมข้อมูลจุดจอดรถและเส้นทางรถประจำทาง',
    url: '/location',
  },
};
